...
使い方: python3 tools/release_check.py design-v21（新しい版）  design-v20（前の版）"""
...
def main(new,old):
    ng=[]
    for t in ['price_check','ruling_mock_check','promise_diff','route_map','decision_needed_check','promise_coverage','policy_diff','fail_closed_lint']:
    ...
    print(o)
    if c!=0: ng.append('promise_diff: 約束の文が変わった（上の +／- を1件ずつ確かめ、意図したものなら README の版の履歴に書く）')
