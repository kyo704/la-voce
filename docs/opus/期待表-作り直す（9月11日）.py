...
out={"版":"2026-09-11","出どころ":"作業指示-権限の事故を直し、記録を残す（9月11日）§2-1・§3",
     "規則":{"名簿":"meibo","役職と 所属":"post","レッスンの 日程":"sched_all OR sched_mine",
...
OUT=os.path.join(ROOT,'docs','opus','期待表-権限の総当たり（9月11日）.json')
