...
def main(a):
    ...
    keys=['tables','columns','constraints','indexes','policies','functions','grants','column_grants','triggers',
          'auth_triggers','default_privs','extensions','rls']   # ★auth の引き金と既定の権限を追加（2026-09-23 の抜け）
    bad=[]
