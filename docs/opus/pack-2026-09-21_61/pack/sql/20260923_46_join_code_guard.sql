-- ★★2026-09-26: ★この ファイルの join_koen_by_code は ★誤りでした
--   ★★記録してから raise ── ★raise が ★記録を 取り消します
--   ★★本番で 確かめました: ★失敗 3回 → ★0行（★守りが 効いていません）
--   → ★★sql/104 で 直しました（★raise を やめ、★null を 返す）
--   ★★この ファイルは ★歴史として 残します。★当て直さないで ください
