...
export default async function AdminPage() {
  ...
  //     ★この 画面は `is_admin` の 門の **内側** です（★:38 の 早い return）。
  //     ★★門は 生まれた ときから あり、★8つの 版 すべてで 取得より 前 です。
  //     ★★いま `is_admin` が true の 方は、★48人中 0人 です。
  //   ★★正しくは「★管理者が この 画面を 開けば 渡る 形が、
  //     ★2026-08-26 から 2026-09-14 まで あった」です。
  //   ★★通った 跡は 見つかって いません。★ただし「渡って いない」とは 書きません。
  //     ★列は いまの 値しか 持たず、★過去は 台帳から 分かりません。
  //   ★詳しくは docs/records/修正の記録-No.019.5-数えるために値を運ばない.md
  //
