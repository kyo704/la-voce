...
const T = {
  ...
  // ★★2026-09-07・Opus の裁定「文言の差し替え（第2版）」§2 の #2。
  //   ★「どうつながるか」は因果です。★こちらが言えるのは「一緒に出ている」まで。
  //   ★主語を「私たちが何をするか」→「あなたが何を見られるか」に移しています。
  feature2Desc: { ja: "夕食の時刻と就寝までの間隔、水分、栄養バランス。前の日に書いたことと、今日の声を、並べて見られます。", en: "Dinner timing and the gap before sleep, hydration, nutritional balance — see what you wrote the day before alongside today's voice.", zh: "晚餐时间与就寝间隔、水分、营养均衡——把前一天所记录的内容，与今天的声音并排查看。", it: "Orario della cena e intervallo prima di dormire, idratazione, equilibrio nutrizionale: potete vedere accanto ciò che avete scritto il giorno prima e la voce di oggi.", de: "Essenszeit und Abstand zum Schlafen, Flüssigkeit, Nährstoffbalance — Sie sehen das gestern Geschriebene neben der heutigen Stimme.", fr: "Heure du dîner et intervalle avant le coucher, hydratation, équilibre nutritionnel : vous voyez côte à côte ce que vous avez écrit la veille et la voix du jour.", es: "Hora de la cena y el intervalo hasta dormir, hidratación, equilibrio nutricional: puede ver junto a la voz de hoy lo que escribió el día anterior.", ko: "저녁 시각과 취침까지의 간격, 수분, 영양 균형 — 전날 적은 내용과 오늘의 목소리를 나란히 보실 수 있습니다.", ru: "Время ужина и промежуток до сна, вода, баланс питания — вы видите рядом то, что записали накануне, и голос сегодня." },
  ...
  // ★★2026-09-07・Opus の裁定「文言の差し替え（第2版）」§2 の #1。
  //   ★「裏付ける」は、証明したことになります。★条件を通ったものしか言えません。
  feature3Desc: { ja: "記録が増えるほど、あなたの声にとって本当に大切な習慣が見えてきます。あなたの感覚と、あなたの記録を、並べて置きます。", en: "The more you record, the clearer the habits that really matter for your voice become. We place what you sense and what you recorded side by side.", zh: "记录越多，对你的声音真正重要的习惯就会越发清晰。把你的感觉与你的记录，并排放在一起。", it: "Più registri, più diventano chiare le abitudini davvero importanti per la tua voce. Mettiamo affiancate la vostra sensazione e ciò che avete registrato.", de: "Je mehr Sie aufzeichnen, desto klarer werden die Gewohnheiten, die für Ihre Stimme wirklich zählen. Wir stellen Ihr Gefühl und Ihre Aufzeichnungen nebeneinander.", fr: "Plus vous notez, plus les habitudes qui comptent vraiment pour votre voix apparaissent. Nous plaçons côte à côte votre ressenti et vos notes.", es: "Cuanto más registre, más claros serán los hábitos que de verdad importan a su voz. Ponemos su sensación y sus registros uno al lado del otro.", ko: "기록이 쌓일수록, 목소리에 정말 중요한 습관이 보이기 시작합니다. 느낀 것과 적은 것을, 나란히 놓아 드립니다.", ru: "Чем больше записей, тем яснее привычки, которые действительно важны для вашего голоса. Мы кладём рядом ваше ощущение и ваши записи." },
