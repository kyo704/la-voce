...
const T = {
  ...
  legalTokushoho: { ja: "特定商取引法に基づく表記", en: "Legal Notice (Japanese Commerce Law)", zh: "基于日本《特定商业交易法》的标示", it: "Informativa legale (legge commerciale giapponese)", de: "Rechtlicher Hinweis (japanisches Handelsgesetz)", fr: "Mentions légales (loi commerciale japonaise)", es: "Aviso legal (ley comercial japonesa)", ko: "특정상거래법에 따른 표기", ru: "Правовая информация (закон о коммерции Японии)" },
