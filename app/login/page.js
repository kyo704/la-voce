  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 4, display: "flex", flexDirection: "column", alignItems: "center", width: "100%", maxWidth: 420 }}>
        ...
        // ★★★`method="post"` を 付けます（★2026-09-20・手元で 見つけました）。
        //   ★★★付けないと、★HTML の 既定は **GET** です。
        //     ★★画面の 仕掛けが まだ 動いて いない 間に 送られると、
        //       ★★合言葉が **住所の 中**に 入ります。
        //     ★★★手元の 開発サーバの 記録に、★実際に そう 残りました。
        //       ★★本番でも、★配る 仕組みの 記録に 残り得ます。
        //   ★★`post` なら、★万一 送られても 住所には 残りません。
        //   ★★ふだんは `onSubmit` が 止めます。★これは その 外れた ときの 備え です。
        <form
          method="post"
