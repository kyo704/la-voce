...
export default function TermsPage() {
  return (
    <main className="legal-doc" style={{ margin: "0 auto", padding: "56px 24px 96px", color: C.ink }}>
      ...
      {/* ★★★2026-09-24・裁定192 ── ★書き換えました。
          ★★前 …「現在の仕様では、18歳未満の方は指導者との連携を行うことができません。」
          ★★それは 2026-09-24 まで 本当 でした ── ★台帳の 引き金が 止めて いました
            （`assert_student_is_adult`）。★裁定107 の 仕組みは 出来て いたのに、
            ★その 先で 弾かれて いました。
          ★★★`sql/76` を 当てて、★引き金の 中身を 直しました。★だから 直せます。
            ★順 …… ★台帳を 先に、★この 字を あと（★Opus の ご指示どおり）。
          ★★15歳未満は いまも お作りに なれません。★年齢を お答えで ない 方も、
            ★先生と つながれません。★そこは 変えて いません。 */}
      <p>ご登録は 15歳以上の方に限ります。ご登録の際に、年齢の区分（15歳未満／15〜17歳／18歳以上）をおたずねします。</p>
      <p>15歳から17歳の方が指導者と連携される場合には、保護者の方のご承知をいただきます。アプリの画面から、保護者の方のメールアドレスあてに1通お送りし、保護者の方が押されると連携できるようになります。保護者の方にアカウントをお作りいただく必要はありません。</p>
      <p>年齢の区分をお答えになっていない場合、指導者との連携はできません。お答えいただければ、お進みになれます。</p>
      <p>記録・ノート・レパートリー・ひつじなど、おひとりでお使いいただく機能は、連携の有無にかかわらずご利用いただけます。</p>
      <hr style={{ border: 0, borderTop: `1px solid ${C.line}`, margin: "28px 0" }} />
      ...
      <p>1. 当方は、本サービスが利用者の特定の目的に適合すること、期待する効用を有すること、および不具合が生じないことを保証しません。</p>
      <p>2. 当方の責めに帰すべき事由により利用者に損害が生じた場合、当方に故意または重大な過失があるときを除き、当方が賠償する責任は、当該損害が生じた時点からさかのぼって12か月間に利用者が当方に支払った利用料金の合計額を上限とします。</p>
      <p>3. 前項の上限は、利用者の生命または身体に生じた損害については適用しません。</p>
      <p>4. 本サービスは、医療行為、診断、治療または医学的助言を行うものではありません。体調について気になることがあるときは、医療機関を受診してください。</p>
      <p>5. 当方は、利用者と第三者（指導者、所属団体その他）との間に生じた紛争について、責任を負いません。</p>
      <hr style={{ border: 0, borderTop: `1px solid ${C.line}`, margin: "28px 0" }} />
      ...
      <p>2026-09-06　第7条の「当社」を「当方」に統一。第1条で「当方」と定めているため、用語をそろえました。内容は変えていません。</p>
</main>
  );
}
