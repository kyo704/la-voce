  ...
  return (
    <main className="legal-doc" style={{ margin: "0 auto", padding: "56px 24px 96px", color: C.ink }}>
      ...
      <div className="legal-list" style={list}>
        ...
        <p style={li}>プランには、「よそおい・おうちのもの」から、毎月1点をお選びいただけることが含まれます。</p>

        <p style={li}>受け取られたよそおいは、解約されたあとも、そのまま残ります。</p>
        <p style={li}>お取り上げいたしません。</p>
      </div>
      {/* ★★正（md）と、1字ずつ合わせてあります。
          ★「記録と」ではなく「記録・」です。★正がそう書いています。
          ★下の1文は、★はじめ写し忘れていました（2026-09-05・確かめが見つけました）。 */}
      <p>記録・書き出しは、いつでも無料です。お金をいただきません。</p>
      <p>退会されたあとも、お手元のファイルはお客さまのものです。</p>
      <p>お金をいただくのは、まとめて見ること（週ごと・月ごと・年ごと）、複数の指標を並べて見ること、本番モードです。</p>
      ...
      {/* ★★2026-09-09、★年額を「1年間 有効な 利用権の 買い切り」に しました。
          ★★checkout は mode: "payment" です。★自動更新は ありません。
          ★書いてあることと、起きることを、★同じにします。 */}
      <p>月額プランは、以後、同じ日に、自動で更新されます。</p>
      <p>年額プランは、1回きりのお支払いです。自動で更新されません。</p>
      ...
      <p>月額プランは、いつでも解約できます。アプリの中から、ご自身で手続きできます。</p>
      <p>解約なさると、次の更新日から、お金はいただきません。</p>
      {/* ★★お支払いの 記録だけは 残る こと（★第3段・2026-09-16）。
          ★★退会の 画面・個人情報の 紙と、★同じ ことを 言います。
            ★★字は lib/paymentRetention.js の RETENTION_LINES_FORMAL です。
            ★★ここは 紙 なので「お客さま」で 書きます（★アプリは「あなた」）。 */}
      <p>ご退会になっても、お支払いの記録は、法人税法・所得税法により7年間保存します。お客さまのお名前やメールアドレスとは切り離して残します。</p>
      <p>年額プランには、解約の手続きがありません。1回きりのお支払いだからです。</p>
      <p>期間が終わると、自動では更新されません。</p>
      {/* ★★「返しません」の すぐ後ろに、★「使えます」を 対で 置くこと。
          ★★2026-09-09 の お決めです。★片方だけに しないこと。 */}
      <p>日割りでのお返しはありません。期間中は、いつでもご利用いただけます。</p>
      <p><strong style={{ color: C.ink }}>記録は、解約しても残ります。書き出しは、いつでも無料です。退会されたあとも、お手元のファイルはお客さまのものです。</strong></p>
