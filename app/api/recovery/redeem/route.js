...
export async function POST(request) {
  ...
  // ★★email_confirm は false です（2026-09-05 夜・★実機で確かめました）
  //
  //   ★狙い ── ★確かめは、このあとの番号でします。
  //     ★ここで「確かめ済み」にすると、★誰のものか分からないアドレスが確定します。
  //
  //   ★★私は、いちど true に変えました。★間違いでした。
  //     ★「確かめていないアドレスには、ログインの番号を送らないはずだ」
  //     ★と推論しました。★動かして確かめずに、変えました。
  //     ★★実機では、★false のまま、★ちゃんと届いて、★ちゃんと通りました
  //       （2026-09-05 夜・A→B の通しで確認）。
  //     ★憲章 §13 ── ★文書と実装が食い違ったら、★実装のほうが事実。
  //       ★ここでは「私の推論」と「実際の動き」でした。★動きが事実です。
  //
  //   ★★動いている形を、★確かめずに変えないこと。
