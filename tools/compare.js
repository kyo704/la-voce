...
const SCREENS = [
  ...
  // ★★4つめの 札（★見本 narabe() の pills・720行）。
  //   ★★2026-09-11、★撮ろうと して 30秒 待って 落ちました。
  //     ★★調べた 結果 ── ★**実装に この 札は ありません**。
  //       lib/lineUp.js の PERIODS は 14日／4週／3か月 の 3つ だけ です。
  //     ★★見本は 4つ です（14日／4週／3か月／本番でそろえる）。
  //   ★★だから 撮りません。★くらべる 絵には「★ありません」と 出ます。
  //     ★★あるふりを しません。★30秒 待つ ことも しません。
  ...
  // ★★通っている ところ（★裁定その68・2026-09-16）。
  { key: "SC-通っているところ", tab: "きょう",
    steps: ["もっとを開く", "通っている ところ"] },
  // ★★中身 と やめる（★2026-09-16）。
  //   ★★中身は「教室の 札」を 押して 開きます。★札の 字は 教室の 名 です。
  //     ★★試しの 教室は「★50通り-01-学長」です。★名で 押します。
  { key: "SC-通っているところの中身", tab: "きょう",
    steps: ["もっとを開く", "通っている ところ", "★50通り-01-学長"] },
  { key: "SC-やめるとどうなるか", tab: "きょう",
    steps: ["もっとを開く", "通っている ところ", "★50通り-01-学長", "この教室を やめる"] },
