...
# ★★★見せかけの 見分けは `screen_b_compare.py` が 持ちます（★2026-09-24）。
#   ★ここにも 同じ ものを 書いて いました。★同じ 決めが 2か所に ある 形 です。
#   ★★あちらが ④に 落とす ので、★ここには もう 来ません。
#     ★★万一 来たら、★あちらの 見分けが 足りない という こと です。
...
def main(conf):
  ...
  for k in sorted(組):
    ...
    宣 = まだと書いてあるか(ps)
    for w in 行:
      # ★★ここに 来る もの は、★あちらが ④に 落とせなかった もの です。
      #   ★★数えて おきます ── ★あちらの 見分けを 育てる ための 手がかり です。
