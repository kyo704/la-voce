...
--   ★2026-09-22 に 本番へ（坂本さんの ご承認）。★移行の 記録に 残って いません。
--   ★★もとの ファイル …… supabase/migration_taba2_164w2_164w1_fx2.sql
--   ★★★時刻（20260922090000 の 下6桁）は **分かりません**。
--     ★当てた 順だけ 正しく 並べて あります。★本当の 時刻では ありません。
--   ★★★2026-09-23 06:50、★`schema_migrations` に 記録しました。
