...
export const COLUMN_SCOPE = {
  ...
  // 気温・湿度の出どころ。★環境の列と同じく、先生には共有しません。
  //   temperature / humidity 自体が「共有しない11列」に入っているため、
  //   その出どころだけを渡す意味がありません。
  weather_source: null,
  morning_edema: "symptoms",
  // ★嗜好品は、先生に共有しません（用語辞書の拡張と嗜好品の記録.md §7）。
  //   吸ったか・飲んだかは、指導のために要る情報ではありません。
  //   知られると、記録そのものをやめる方向に働きます。
  smoked_today: null,
  drank_today: null,
