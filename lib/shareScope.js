 ...
 */
// ★2026-09-03 追記：throat_symptoms_other を足しました。
//   いま入力欄はありませんが（過去の版のデータが残りえます）、自由記述に
//   病名が書かれる欄です。★共有の仕組みを作り直すことがあっても、
//   ここは渡しません。「足すことはあっても、減らさない」に従っています。
export const NEVER_SHARED_COLUMNS = [
  "throat_symptoms_other",
  "weather_source",
  "smoked_today",
  "drank_today",
  "type_fields",
  ...
  //   ★出どころ docs/lavoce-食事と就寝の設計.md §14-9
  //     「★教師・管理者・保護者・共有カード・管理画面に一切出さない」
  //   ★★頭の側を上げて寝るのは、★逆流に対して★することです。
  //     ★だから、★記録そのものが、★病歴に近づきます。
  //   ★一覧の正は lib/refluxCare.js の REFLUX_CARE_COLUMNS です。
  "sleep_side",
  "head_raised",
  "belly_tight",
  // ★★食事の印8つ（★2026-09-08）。
  //   ★逆流に関わる分析のためのもので、★同じ重さです。
  //   ★dinner_tags が渡っていないのと、★同じ扱いにします。
  "meal_marks"
];
