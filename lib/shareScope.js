// ============================================================================
// ★★このファイルは、★どこからも import されていません。★それで 正しいです。
//   （★2026-09-09・坂本さんのお決め・案A「残す」）
//
//   ★★消さない わけ
//     ★先生が 生徒の記録を 読む道は、★2026-09-01 に 消しました。
//       ★get_student_entries（SECURITY DEFINER）ごと 消えています。
//       ★★2026-09-09、★データベースでも 0件であることを 確かめました。
//     ★★だから、★この表を 呼ぶ所は もう ありません。
//
//   ★★それでも 残すのは、★これが「★先生に 見せない 11列」の 台帳 だからです。
//     ★見張りが 5本、★このファイルを 読んでいます
//       share-scope.test.js／no-teacher-entries-access.test.js／
//       guard-leak.test.js／no-share-scope-copy.test.js／export-data.test.js
//     ★★消すと、★守るべき列の 一覧が、★どこにも 無くなります。
//     ★★「呼ばれていないから 消す」を、★ここでは しません。
//       ★呼ばれていないことが、★この場合は 正しい状態です。
//
//   ★★足すときの 注意
//     ★entries に 列を 足したら、★ここにも 足すか、★足さないかを 決めること。
//     ★決めないまま 置くと、★次に 先生の道を 作る人が、★既定で 通してしまいます。
//
//   ★見張り components/tests/share-scope.test.js
// ============================================================================
