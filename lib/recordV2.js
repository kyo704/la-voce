...
export function sectionIsOpen(sectionKey, { layoutV2, openSheet }) {
  ...
  // ★★2026-09-11 夜、★この お決めは 2度 動きました。★経緯を 残します。
  //
  //   ★★① 坂本さん「隠す のでは なく、★見本と 同じ 畳む しくみを 使って」
  //     ★★私が「見本に 畳む しくみは ない」と 誤って ご報告したためです。
  //   ★★② 坂本さん「先ほどの 指示は 誤りです。★当初の 決定どおり 隠して」
  //     ★★理由 ── ★パッサッジョの通りにくさ・高音の出しやすさ などの
  //       ★専門の 記録項目は、★見本 そのものに ありません。
  //     ★★畳む しくみ（foldNotes）は、★見本に 実際に ある 注記 ──
  //       ★くらべる の「調べていることの 順番」など ── の ための ものです。
  //       ★★この 専門項目とは、★関わりが ありません。
  //   ★★つまり、★畳むのは 注記だけ。★節は 隠す。★2つは 別の 話です。
  //
  // ★★列も、★これまでに 書かれた 値も、★1つも 消していません。
  //   ★消したのは「画面に 出す」ことだけです。
  // ★★どこに 置き直すかは、★すべての 画面が 見本どおりに なった あとで、
  ...
  // ★★表に 載って いない 節は、★気候・滞在地（env）1つ だけです。
  //
  //   ★★2026-09-11、★坂本さんが お決めを 変えられました。
  //     ★★5-b は ㋒（そのまま 下に 残す）でした。★①消す に なりました。
  //     ★「気候・滞在地（13項目）は ①消す（画面から 削除）で、進めてください。
  //       列・記録は、1つも、消さず、画面に出すことだけを、やめてください。」
  //
  //   ★★お決めが 変わった 理由 ── ★私の お伝えが 足りて いませんでした。
  //     ★★㋒ を お決めに なった とき、★私は「表に 載って いない 節」と
  //       ★しか 申し上げず、★中身が 13項目 ある ことも、
  //       ★★画面の 約束と 食い違う ことも、★お伝えして いませんでした。
  //
  //   ★★食い違いの 中身（★これが 決め手に なりました）
  //     ★この 画面は、★すぐ上の .warn で こう 約束して います ──
  //       「部屋の しめり は こちらで 取ります。…★この2つは 聞きません。」
  //     ★★その すぐ下で、★気温と 天気を 聞いて いました。
  //     ★★画面が、★自分と 食い違って いました。
  //
  //   ★★見本に、★気候・滞在地の 入力欄は 1つも ありません。
  //     ★気温・天気・滞在地・公演地・騒音・フライト・時差・マスク・粉塵・空調
  //       ★★どれも 0件です。
  //     ★「部屋の しめり」は 4回 出ますが、★どれも「自動で 取る」側です。
  //     ★「湿度」「環境」「乾燥」「喫煙」は、★学ぶ の 記事の 題です。
  //
