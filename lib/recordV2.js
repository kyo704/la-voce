...
export function hasSceneCondition(entry) {
  ...
  return ve.some((v) => v && typeof v.bodyFeel === "number" && Number.isFinite(v.bodyFeel));
}
...
export const RECORD_FOLDS = [
  { key: "sing",  label: "歌った時間",   sections: ["practice", "voice", "typeFields"] },
  { key: "body",  label: "からだのこと", sections: ["body", "env", "exercise"] },
