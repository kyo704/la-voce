...
export const SYMPTOM_LOCATION = {
  ...
  "鼻づまり": "鼻・のどの奥",
  "咳": "鼻・のどの奥",
  // ★★2026-09-11、★見本の SH['karada'] から 4つ 足しました。
  //   ★★古い 8つは 1つも 消していません（★坂本さんの お決め ①㋐）。
  //   ★★「胃が もたれる」で、★場所が 1つ 増えました。
  //     ★のど でも 鼻 でも ありません。★「おなか」です。
  //   ★★「肩が こわばる」で、★場所が もう 1つ 増えました ──「からだ」。
  //     ★のど でも 鼻 でも おなか でも ありません。
  //   ★★「鼻が つまる」は 足していません。★「鼻づまり」が もう あります。
  "のどが いがらっぽい": "のど",
  "のどが 渇く": "のど",
  "せきばらい": "鼻・のどの奥",
  "胃が もたれる": "おなか",
  "肩が こわばる": "からだ",
  // ★★2026-09-11、★営業資料 v5 の 1ページ目の 例に あります。
  //   ★のど でも 鼻 でも おなか でも ありません。★息は からだ ぜんたいの ことです。
  "息が 続かない": "からだ"
};

/** 並べる順番。★場所の言葉だけ。「系」を使わないこと。 */
export const LOCATION_ORDER = ["のど", "鼻・のどの奥", "おなか", "からだ"];
