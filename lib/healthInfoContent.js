...
export const HEALTH_INFO_CONTENT = {
  disclaimer: {
    ...
    ko: "여기에 적힌 내용은 일반적인 정보 제공을 목적으로 하며, 의학적 진단이나 치료를 대신하지 않습니다. 증상이 지속되거나 불안하시면 반드시 이비인후과(가능하다면 음성을 전문으로 하는 의사)에 상담하세요.", ru: "Информация, представленная здесь, предназначена только для общего ознакомления и не заменяет медицинскую диагностику или лечение. Если симптомы сохраняются или вызывают беспокойство, обязательно обратитесь к отоларингологу (по возможности — специализирующемуся на голосе)."
  },
  ...
  s1Para4Intro: {
    ...
    ko: "일반적으로 알려진 대책입니다(진단이나 치료를 대신하지 않습니다).", ru: "Часто рекомендуемые подходы (они не заменяют диагностику или лечение)."
  },
  s1List5: {
  ...
  s2Note: {
    ...
    ko: "이는 어디까지나 일반적인 정보이며 진단이 아닙니다. 목소리 불편이 2주 이상 지속되면 진료를 권장합니다.", ru: "Это лишь общая информация, а не диагноз. Если проблемы с голосом сохраняются более 2 недель, рекомендуем обратиться к врачу."
  },
  ...
  s6Title: {
    ...
    ko: "키를 기준으로 한 참고 체중 범위에 대하여", ru: "Об ориентировочном диапазоне веса на основе роста"
  },
  s6Para1: {
    ...
    ko: "'오늘의 기록'의 신체 데이터란에 표시되는 체중 범위는, 일반적인 건강 지표인 BMI(체격지수)의 표준 범위(18.5~24.9)를 바탕으로 산출한, 어디까지나 일반적인 건강 참고치입니다. 성악가에 특화된 전용 계산식이 아닙니다. 체중과 가창 능력의 관계에는 개인차가 크며, 근육량이나 체조성, 그리고 발성 기술의 영향이 훨씬 크다고 알려져 있습니다. 이 수치에만 얽매이지 말고, 컨디션 관리를 위한 참고 정보 중 하나로 받아들여 주세요.", ru: "Диапазон веса, отображаемый в разделе «Данные о теле» в «Записи за сегодня», рассчитывается на основе стандартного диапазона ИМТ (индекса массы тела) (18,5–24,9) — общего показателя здоровья. Это не формула, разработанная специально для оперных певцов. Связь между весом тела и вокальными способностями сильно варьируется у разных людей, и такие факторы, как мышечная масса, состав тела и вокальная техника, считаются гораздо более значимыми. Не зацикливайтесь только на этой цифре — воспринимайте её лишь как один из справочных ориентиров для общего управления здоровьем."
  }
};
