...
//
//   ★★★下の 2行は **約束** です。★消さないこと ──
//     ★「この 教室の ことだけ です。ほかの 教室とは 混ざりません。」
...
export const ROWS = Object.freeze([
  Object.freeze({ to: "名簿", name: "名簿", sub: "", any: ["meibo"] }),
  Object.freeze({ to: "招く", name: "生徒を 招く", sub: "招待コードで", any: ["meibo"] }),
  Object.freeze({ to: "役職の一覧", name: "役職", sub: "", any: ["post", "master"] }),
  Object.freeze({ to: "組織", name: "学部・学科", sub: "階層で", any: ["master"] }),
  Object.freeze({ to: "場所を決める", name: "場所", sub: "ホール・教室", any: ["koma"] }),
  Object.freeze({ to: "プランを選ぶ", name: "プラン", sub: "1人あたりの 段",
    any: ["bill", "bill_pay"] })
]);
