 ...
 *
 *   ★★2026-09-13、★admin から `threads` を 外しました。
 *     ★★学科長（base=admin）は `renraku_all` も `monka_write` も
 *       ★持って いません。★それでも 連絡の タブが 出て いました。
 *       ★★見本は「だめ」、実装は「出す」── ★漏れでした（★120通りの 3件の 1つ）。
 *
...
const BY_ROLE = Object.freeze({
  ...
  admin: ["home", "schedule", "roster", "events"],
  staff: ["schedule"],
  teacher: []
});
