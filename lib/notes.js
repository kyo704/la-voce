...
//     ★見本④「★ノートの中。★タブは 増やしません」。
//     ★★タブを 増やさずに、★連絡を 置くための 形です。
//   ★★だから renraku: true を 立てます。★画面が、★何を 出すかを 決められます。
//   ★鍵（studio）は 変えません。★表の 決まりが それで 書かれています。
export const NOTE_KINDS = Object.freeze([
  { key: "practice", label: "稽古" },
  { key: "repertoire", label: "レパートリー" },
  { key: "studio", label: "連絡", renraku: true },
  { key: "clinic", label: "受診用" }
]);

/** ★その帯は、★ノートでは なく 連絡か。 */
export function isRenrakuKind(kind) {
