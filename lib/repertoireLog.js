 ...
 */
/**
 * ★たなの 下の 註（★見本 `SC['たな']` の 下の note・★2026-09-24）。
 *
 *   ★★見本は 3行 です。★書いたのは 2行 です。
 *
 *   ★★★書かなかった 1行 ──「ノートの レパートリーと 同じ中身です。」
 *     ★★ちがいます。★たなは **少ない** です。
 *       ★たな …… `repertoireLog(entries)` ── ★**記録**に 出て きた 曲
 *       ★ノート … 台帳 ∪ 音の高さの 行 ∪ 曲の ノート の 合わせ
 *     ★★足しただけ で、★まだ 1日も 記録して いない 曲は、★たなに 並びません。
 *     ★★★それで 正しい と 考えて います ── ★たなは「歌ってきたもの」です。
 *       ★★足しただけ の 曲は、★まだ 歌って いません。
 *     ★★けれど「同じ中身」と 書くと 嘘に なります。★書いて いません。
 *     ★★見本の 字を どちらに 合わせるかは、★決めごと です
 *       （`docs/ledgers/08-保留している決め.md`）。
 */
export const SHELF_NOTES = Object.freeze([
  "飾りでは ありません。ノートの レパートリーと つながって います。",
  "出来・点数・順位を 出しません。"
]);
