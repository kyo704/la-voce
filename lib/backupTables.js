...
export const BACKUP_TABLES = [
  ...
  { table: "link_consents",            critical: false },
  // 組織の予定と、出るという印（2026-09-02）
  { table: "org_events",               critical: false },
  { table: "org_event_participants",   critical: false },
  ...
  { table: "notice_batches",           critical: false },
  { table: "notice_targets",           critical: false },
