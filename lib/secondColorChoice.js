...
//
//   ★★どなたが 選べるか ── ★いまは 決められません。
//     ★★アプリに「¥580 と ¥1,280 の どちらか」を 見分ける手がかりが
//       ★1つも ありません。subscriptions は status（trialing／active）だけで、
//       ★★段（tier）を 持っていません。
//     ★だから いまは、★門の名簿（NEXT_PUBLIC_SECOND_COLOR_USER_IDS）で
//       ★出し入れします。★段が入ったら、★ここ1か所を 差し替えます。
//
 ...
 */
export function mayChooseSecondColor(userId, env) {
