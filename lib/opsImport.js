...
//   ★★★「新しく 入る 方」と「取り消す」は、★できました（★裁定 その109・2026-09-20）。
//     ★★下書きの 表（`roster_drafts`）に 入ります。★名簿には まだ 入りません。
//     ★★取り消せるのは、★1人も お送りして いない あいだ だけ です。
export const IMPORT_NOT_YET = Object.freeze([
  ...
  {
    key: "change_undo",
    line: "いま 居る 方の 直し を 取り消す",
    why: "前の 値を しまう ところが ありません。"
      + "取り消せるのは、下書きに 入った ぶん だけ です",
    needs: "前の 値 を しまう 表、という お決め"
  },
  {
    key: "remember",
    line: "つなぎ方を 覚える",
