...
/**
 * ★とりけしの 画面の 註（★見本 `SC['同意']` の note・★2026-09-24）。
 *
 *   ★★見本は 3つ です。★書いたのは 2つ です。
 *
 *   ★①「消すのは 退会か、記録の 削除からです。」
 *     ★★とりけしは 削除では ありません。★1行も 消えません。
 *       ★消す 道は 2つ ── ★退会（`lib/accountDeletion.js`）と、
 *       ★記録の 削除 です。★どこで 消せるかを 言わないと、
 *       ★★「とりけせば 消える」と 読まれます。
 *
 *   ★②「同意は、契約では 代えられません。ご本人から いただきます。」
 *     ★★本当 です ── ★`consent_records` は お一人ごと で、★決まりは ご本人だけ。
 *       ★学校からも 先生からも、★代わりに 押す 道が ありません。
 *     ★★学校が 束で 契約しても、★同意は 束に なりません。
 *
 *   ★★★③「18歳未満の方は、保護者の 同意も いただきます。」── ★書いて いません。
 *     ★★この 品では ちがいます。★保護者の ひとことが 要るのは
 *       ★**学校に 入る とき だけ** です（★裁定 その107）。
 *     ★★記録を 残す ことには 要りません。★15歳未満の 方は、
 *       ★そもそも お入りに なれません（★登録の ときに 弾いて います）。
 *     ★★見本の この 1行は、★この 画面では 嘘に なります。
 */
export const WITHDRAW_NOTES = Object.freeze([
  "とりけしても、これまでの 記録は 消えません。消すのは 退会か、記録の 削除からです。",
  "同意は、契約では 代えられません。ご本人から いただきます。"
]);
