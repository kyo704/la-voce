...
// ============================================================================
import { keysOf } from "@/lib/pageFields";
 ...
 *   ★★★2026-09-26 ── ★一覧を 持たなく なりました（★裁定207）。
 *     ★節は `public.my_page_fields()` が 出します。★呼ぶ 側が 渡します。
 *     ★★だから これは 定数では なく **関数** です。
 *       ★★空を 渡されたら 空を 返します ── ★勝手に 並べません。
 */
export function paperOrder(fields) {
  return keysOf(fields);
}
