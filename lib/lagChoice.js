 ...
 */
// ★★★この 4つを 残す と 決まりました（★2026-09-25・坂本さんの お決め）。
//
//   ★★見本『しらべていること』は ちがう 4つを 出して います ──
//     ★同じ日 ／ 翌日 ／ 2日後 ／ 3日後。
//   ★★坂本さんの お決め ──「②既存の実装（lagChoice.js）の語彙を維持します」
//     ★わけ 3つ ──
//       ★① この 4分岐は「★同じ 日付でも 取る 欄が ちがう」を 含んで いる
//         （★前の夜 と 前の日 は 同じ 日付 です・`lib/compareView.js` の `sourceDateOf`）。
//       ★② 影響は 限られて いる（★実装3本・★台帳に 保存 0件）ので 変えやすい 状況 だが、
//         ★★★変えやすさは 変える 理由に なりません。
//       ★③ 見本の 4段は **未来向き**、★こちらは **過去向き** です ──
//         ★言い換えでは 済まない かも しれません。
//   ★★★裁定197（2026-09-25）で 決まりました ── ★**この 4つに 統一** します。
//     ★見本を 直して いただきました（`いつの くらしと くらべますか`／
//       ★その日の朝・前の夜・前の日・2日まえ）。
//     ★★決め手（★裁定197 の 3つ目）──
//       「★『2日後』は 未来と 読めるが『2日まえ』は 読めない。
//         ★このアプリは 予測を しないため、★未来と 誤解される 表現は 避けるべき」
//     ★★★同じ 関係を、★どちらから 見るかの ちがい でした。
//       ★声を 主語に します（★裁定111 の「〜と 一緒に 出て います」も 声が 主語）。
