...
/** ★戻る 先（★見本 `bk('公演の運営')`）。 */
export const BACK_TO = "公演の 運営";

/** ★題。 */
export const TITLE = "参加費";

/** ★上の 3行の 札（★見本の `card`）。 */
export const HEAD_EACH = "ひとり";
export const HEAD_PAID = "いただいた";
export const HEAD_YET = "まだ";

/** ★ひとりずつ の 節（★見本の `sh3`）。 */
export const LIST_HEAD = "ひとりずつ";
...
export const NOTES = Object.freeze([
  "お金の やりとりは、この アプリの 外で 行います。ここは いただいたかどうかの 記録だけ です。",
  "まだの方に、アプリから 催促は しません。お手元の 一覧として お使いください。",
  "出演者には ご自分のぶんだけ 見えます。ほかの方の ことは 出ません。",
