...
export const FIELDS = Object.freeze([
  Object.freeze({ key: "performed_on", label: "日", placeholder: "", kind: "date" }),
  Object.freeze({ key: "label", label: "名前", placeholder: "", kind: "text" })
]);

/** ★ことばの 欄（★見本の `textarea`）。 */
export const WORDS_LABEL = "本番前の 自分への ことば";
export const WORDS_OPTIONAL = "（書かなくて かまいません）";
export const WORDS_PLACEHOLDER = "本番の朝の 自分に 言っておきたいこと";

/** ★札。 */
export const BTN_OK = "これで いい";

/** ★書けた とき の 一言（★見本の `toast`）。 */
export const SAVED = "書きました";
