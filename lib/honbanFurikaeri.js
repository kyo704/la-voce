...
export const TITLE = tx("本番の ふりかえり");

/** ★何日ぶん（★見本 ──「前の 7日」）。 */
export const DAYS = 7;

/** ★節の 題。 */
export const HEAD = tx("前の 7日");

/** ★書いて いない 日（★0 と 書きません）。 */
export const NOT_WRITTEN = tx("書いていません");

/** ★下の 断り（★約束。★消さないこと）。 */
export const NOTES = Object.freeze([
  tx("よい わるいは 言いません。並べるだけです。"),
  tx("2回目の 本番から、前回と 重ねて 見られます。"),
  tx("本番の 前の日と 当日は、何も 出しません。"),
  tx("ご自分で 登録された 本番だけを 使います。学校の 行事からは 引きません。")
]);
