...
export const MINE_LINKS = Object.freeze([
  ...
  // ★★★2026-09-24・裁定195 ── ★カレンダー。
  //   ★★下の 字は **切り替えで 変わります**（★`lib/calendarSub.js` が 決めます）。
  //     ★開いて いれば「1度 つなぐと…」、★閉じて いれば「1件ずつ」。
  //   ★★行 そのものは いつも 出します ── ★どちらの 姿でも 使える 画面 です。
  { key: "cal", label: "カレンダー", sub: "" }
]);
...
export const MINE_NOT_MADE_YET = Object.freeze([
  ...
  // ★★「カレンダーにつなぐ」は 2026-09-24 に 作りました（★裁定195）。
  //   ★`components/CalendarConnect.jsx`。★切り替え（`cal_sub`）で 姿が 変わります。
]);
