...
export const TYPE = {
   ...
   * ★下の 但し書き（★見本の .note）。
   *
   *   ★出どころ 見本の CSS ── .note{font-size:11px;color:var(--ink3);line-height:1.8}
   *
   *   ★★2026-09-11、★この 名前が ありませんでした。
   *     ★★6つの ファイルが TYPE.note を 読んでいました。
   *     ★★undefined を 展開しても JS は 落ちません。★何も 起きないだけです。
   *       ★→ ★但し書きの 字の 大きさも 色も、★1つも 効いていませんでした。
   *       ★→ ★親の 字を そのまま 継いで、★大きく 黒く 出ていました。
   *     ★build も lint も 通りました。★実機でしか 見えません。
   *
   *   ★★色は ink3 では なく ink2（C.inkSoft）です。
   *     ★坂本さんの お決め（2026-09-10）── ink3 は 罫線・アイコン・区切りにだけ。
   */
  note: { fontSize: rem(11), fontWeight: 400, color: C.inkSoft, lineHeight: 1.8 },
...
// ★角の 丸み（★tokens.md §4）
// ----------------------------------------------------------------------------
// ★★2026-09-11、★pill が ありませんでした。
//   ★UiV2 の Pill が RADIUS.pill を 読んでいて、★角丸が 効いていませんでした。
//   ★見本の CSS ── .pill{border-radius:99px}
export const RADIUS = { card: 14, btn: 13, speak: 16, pill: 99 };
