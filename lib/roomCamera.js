 ...
 * ★追いつく 速さ（ミリ秒）。
 *
 *   ★★羊の 歩きより ゆっくりにします。★同じ 速さだと、★羊が 止まって 見え、
 *     ★部屋の ほうが 動いているように 見えます。★酔います。
 */
...
/** ★そのまま style に 入れられる形。 */
export function cameraStyle(cam, moving) {
  ...
  return {
    ...
    transition: moving ? "none" : `transform ${EASE_MS}ms ease-in-out`,
