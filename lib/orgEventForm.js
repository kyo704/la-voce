 ...
 *
 *   ★★★一覧にも、★入力の 画面にも、★同じ 字を 出します（★裁定 その117・2026-09-20）。
 *     ★★約束は「出す 人」だけの ものでは ありません。
 *     ★★一覧を 見るのは 生徒・先生・事務 です。★みなさん です。
 *     ★★「出欠は 集めません」は、★見る 人が 知る こと です。
 *       ★★出す 人に だけ 見せると、★見る 人は「なぜ 出欠が 無いか」が 判りません。
 *   ★★★名を `FORM_NOTES` から 変えました。★入力の 画面 だけの ものでは ありません。
 *   ★★★2か所で 字を 変えません（★裁定 その113 §1 EXCEPTION）。★この 1つ から 出します。
 */
export const EVENT_NOTES = Object.freeze([
  // ★★★「は」→「を」（★裁定 その118・2026-09-20）。★見本の 一覧の `.note` が「を」です。
  //   ★★「出欠は 集めません」── ★ほかは 集めるかも、と 読めます（★「は」は 対比）。
  //   ★★「出欠を 集めません」── ★この 機能が 集めません。★範囲が 決まります。
  //   ★★★見本の `P_gyojiEdit` の `.note` は「は」の まま です。★そちらは 見本を
  //     ★★直して いただく ほうに 数えました（★docs/records/…-裁定117.md）。
  "出欠を 集めません。出席の 提出も、その 一覧も ありません。",
