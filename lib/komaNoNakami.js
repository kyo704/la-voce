...
export const BACK_TO = "レッスンの 日程を 組む";
 ...
 */
export const GONE_TITLE = "外れています。";
export const GONE_HOW = "戻って 置き直してください。";
...
/** ★節の 題（★見本の `fl`）。 */
export const HEAD_LEN = "オプション　── 長さ";
export const HEAD_PLACE = "オプション　── 場所";
export const HEAD_REPEAT = "オプション　── 繰り返し";
export const HEAD_UNTIL = "オプション　── いつまで";

/** ★場所を 足す・消す（★見本の 右上の 札）。 */
export const PLACE_EDIT = "足す・消す ›";

/** ★長さの 下の 1行（★見本の `usu`）。 */
export const LEN_HINT = "上下に スワイプして 合わせます（1分きざみ）";
...
export const REPEATS = Object.freeze([
  Object.freeze({ key: "once", label: "この日だけ" }),
  Object.freeze({ key: "weekly", label: "毎週" }),
  Object.freeze({ key: "biweekly", label: "隔週" }),
  Object.freeze({ key: "monthly", label: "月1回" })
]);
...
export const UNTIL_EMPTY = "決めていません";
export const UNTIL_PICK = "カレンダーで 選ぶ ›";
 ...
 */
export const UNTIL_HINT = "日は カレンダーからだけ 選べます（押し間違いを 防ぐため）";
...
export const WHY_CANNOT = "「いつまで」を 決めてください。";
