...
/**
 * ★見本の 但し書き（.warn）。★1文字も 変えないこと。
 *
 *   ★出どころ docs/design/pack-final/00-動く見本（さわれる・全画面）.html
 *     の narabe()／kuraberu() の 1行目（★git hash 7c7c720）
 *
 *   ★★2026-09-11、★字を 直しました。
 *     ★★前の 字は、★9月9日の 古い 見本④の ものでした ──
 *       「ここに出るのは、あなたが書いたことの並びです。
 *        　原因かどうかは、分かりません。疑いながら 見てください。」
 *     ★★いまの 正は 4本の 動く見本 だけです（★坂本さん・2026-09-11）。
 *       ★そこには「疑いながら 見てください。」が ありません。
 *       ★語の あいだの 空きも ちがいます。
 *   ★★1行です。★見本は <br> を 入れて いません。
 */
export const LINE_UP_NOTE =
  "ここに出るのは、あなたが 書いたことの 並びです。原因かどうかは 分かりません。";
