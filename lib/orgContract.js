...
/** ★移せなかった わけ（★台帳が 返す 符号 を、★画面の 字に します）。 */
export const CONTRACT_FAILED = Object.freeze({
  NOT_AUTHENTICATED: "入り直して から、もう一度 お試し ください。",
  NOT_CONTRACT_OWNER: "いまの 契約者 だけ が、引き継ぐ 方を 決められます。",
  NOT_A_MEMBER: "その方は、この 学校に いらっしゃいません。",
  NO_MASTER: "その方は、学校ぜんぶの 札を お持ちでは ありません。"
});
export const CONTRACT_FAILED_OTHER = "いま 引き継げませんでした。";
export const CONTRACT_DONE = "引き継ぎました。";
