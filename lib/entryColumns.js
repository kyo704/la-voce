...
export const PENDING_COLUMNS = [
  "morning_edema"   // supabase/migration_morning_edema.sql（2026-08-30 に本番の保存が止まった列）
,
  "smoked_today",   // supabase/migration_luxury_fields.sql
  "drank_today"     // supabase/migration_luxury_fields.sql
];
