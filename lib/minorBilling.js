...
export function offeredPlans(band) {
  ...
  //   ★★理由。★「保護者の同意を得た」を、★こちらは確かめられません。
  //     ★確かめられないことを、★確かめたように扱わない。
  //     ★取り消されても困らないようにする、より、★はじめから売らない。
  //   ★記録は、これまでどおり全部お使いいただけます。★取り上げません。
...
export function needsMinorConsentScreen(band) {
  // ★★2026-09-07、★案C。★同意の画面そのものを、やめました。
  //   ★売らないので、★同意をいただく相手がいません。
  //   ★★「保護者の同意」という言葉を、★どこにも出しません。
  //     ★得たかどうかを確かめられないまま、★得たように書いていました。
  return false;
}
 ...
 */
// ★★3Dセキュア（★2026-09-07）。
//   ★もとは「未成年に売るなら要る」という位置づけでした。
//   ★★案C で、未成年には売らなくなりました。★理由は変わりました。
//     ★いまは「★大人にも、★かけたほうがよい」から掛けています。
//     ★通ると、★責任がカード発行会社へ移ります。
//   ★月額にも単発にも、同じものをかけます。
