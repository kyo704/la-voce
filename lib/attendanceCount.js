 ...
 */
//   ★★★見本は「★」と 書いて います。★けれど 出荷できません。
//     ★★2026-09-15 の お決め（Opus・SEVERITY 2）──
//       ★「★」は 私たちが 紙の 中で 使う 印 です。★画面に 出しません。
//     ★★見張り `components/tests/no-star-in-ui.test.js` が 止めます。
//   ★★★だから「※」に します。
//     ★★裁定 その90 §4 が 求めて いるのは ──
//       ★「色を 使わない」「印だけ」「責める 形に しない」。
//     ★★「※」は その 3つ を みたします。★形が ちがう だけ です。
//   ★★★Opus に お伝えする ことです。★裁定 その90 の 字を どう するか。
...
export const SHORT_NOTE =
  `${SHORT_MARK}は 規定に 足りない 見込みです。責める ものでは ありません。`;
