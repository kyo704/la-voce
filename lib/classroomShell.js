...
// ★★`*_name_at` …… ★そのときの 名前（★裁定168 ★3・2026-09-22）。
//   ★★書いた 人・門下の 先生が 退会すると、★`author_id`・`teacher_id` は null に なります。
//   ★★名前が 消えない ように、★書いた ときの 名前を 写して あります。
export const MESSAGE_COLUMNS =
  "id, org_id, teacher_id, body, created_at, withdrawn_at, author_name_at, teacher_name_at";
