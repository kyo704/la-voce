...
/** ★戻る 先（★見本 `bk('経歴')`）。 */
export const BACK_TO = "経歴";

/** ★題。 */
export const TITLE = "見た目を 選ぶ";
...
/** ★節の 題（★見本の `sh3`）。 */
export const HEAD_LOOK = "組み方";
export const HEAD_ORDER = "録画の 並び";
export const HEAD_LANG = "ことば";

/** ★組み方の 4つ（★見本 `PF_LOOK`）。 */
export const LOOKS = Object.freeze(["おちついた", "あかるい", "古典的な", "そっけない"]);

/** ★録画の 並びの 3つ（★見本 `PF_ORDER`）。 */
export const ORDERS = Object.freeze(["本番の 順", "曲目の 順", "自分で 並べる"]);

/** ★ことばの 2つ（★見本）。 */
export const LANGS = Object.freeze([
  Object.freeze({ key: "ja", label: "日本語", free: true }),
...
export const EN_LINE =
  "英語の ページは、海外の オーディションに そのまま お使いいただけます。";

/** ★できあがりを 見る（★見本の 札）。 */
export const BTN_PREVIEW = "できあがりを 見る";
