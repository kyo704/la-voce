 ...
 *     （★2026-09-10・Opus の 追加の裁定。★坂本さん経由）。
 *     ★★レイアウトの正 §7-3 と §7-4 が 食い違っていた、という 発見です。
 *     ★★「本番でそろえる」だけ、★本番の 3日前〜翌々日は 出しません。
 *       ★ならべる・さかのぼる は、★これまでどおり 出します。
 *   ★★いま 鍵を 足しません。★その機能が まだ 無いからです。
 *     ★「作った ものは、必ず どこかから 呼ばれているか」という 決めです。
 *     ★★作る ときに、★ここへ 1つ 足してください。★それで 効きます。
 */
