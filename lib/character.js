...
// ===== ショップカタログ =====
// category: hat | outfit | accessory | floor | wall | window | scenery | backdrop | furniture | garden
...
export const SHOP_ITEMS = [
  ...
  { key: "outfit_kimono_male", category: "outfit", cost: 0, origCost: 130, nameKey: "itemOutfitKimonoMale" },
  { key: "outfit_kimono_female", category: "outfit", cost: 0, origCost: 130, nameKey: "itemOutfitKimonoFemale" },
  { key: "outfit_tuxedo", category: "outfit", cost: 0, origCost: 140, nameKey: "itemOutfitTuxedo" },
  { key: "outfit_tailcoat", category: "outfit", cost: 0, origCost: 160, nameKey: "itemOutfitTailcoat" },
  { key: "outfit_dress", category: "outfit", cost: 0, origCost: 160, nameKey: "itemOutfitDress" },
  { key: "outfit_king_robe", category: "outfit", cost: 0, origCost: 400, nameKey: "itemOutfitKingRobe" },
  ...
  { key: "accessory_chopsticks", category: "accessory", cost: 0, origCost: 15, nameKey: "itemAccessoryChopsticks" },
  { key: "accessory_fork", category: "accessory", cost: 0, origCost: 15, nameKey: "itemAccessoryFork" },
  { key: "accessory_bottle", category: "accessory", cost: 0, origCost: 20, nameKey: "itemAccessoryBottle" },
  { key: "accessory_pet_bottle", category: "accessory", cost: 0, origCost: 15, nameKey: "itemAccessoryPetBottle" },
  ...
  { key: "wall_wainscoting", category: "wall", cost: 0, origCost: 90, nameKey: "itemWallWainscoting" },
  ...
  { key: "window_bamboo_washi", category: "window", cost: 0, origCost: 70, nameKey: "itemWindowBambooWashi" },
  { key: "window_grand", category: "window", cost: 0, origCost: 110, nameKey: "itemWindowGrand" },
  ...
  { key: "scenery_italy", category: "scenery", cost: 0, origCost: 80, nameKey: "itemSceneryItaly" },
  { key: "scenery_germany", category: "scenery", cost: 0, origCost: 80, nameKey: "itemSceneryGermany" },
  { key: "scenery_france", category: "scenery", cost: 0, origCost: 80, nameKey: "itemSceneryFrance" },

  // 庭の背景（山並みの見え方）／部屋の空間拡張
  { key: "backdrop_mountains_near", category: "backdrop", cost: 0, origCost: 100, nameKey: "itemBackdropMountainsNear" },
  { key: "backdrop_mountains_huge", category: "backdrop", cost: 0, origCost: 260, nameKey: "itemBackdropMountainsHuge" },
  { key: "backdrop_room_expand", category: "backdrop", cost: 0, origCost: 1200, nameKey: "itemBackdropRoomExpand" },
  { key: "backdrop_garden_expand", category: "backdrop", cost: 0, origCost: 1200, nameKey: "itemBackdropGardenExpand" },
  { key: "backdrop_western_castle", category: "backdrop", cost: 0, origCost: 220, nameKey: "itemBackdropWesternCastle" },
  { key: "backdrop_japanese_castle", category: "backdrop", cost: 0, origCost: 220, nameKey: "itemBackdropJapaneseCastle" },
  { key: "backdrop_bamboo_grove", category: "backdrop", cost: 0, origCost: 160, nameKey: "itemBackdropBambooGrove" },
  { key: "backdrop_forest", category: "backdrop", cost: 0, origCost: 160, nameKey: "itemBackdropForest" },
  { key: "backdrop_sheep_pasture", category: "backdrop", cost: 0, origCost: 200, nameKey: "itemBackdropSheepPasture" },
  { key: "backdrop_big_man", category: "backdrop", cost: 0, origCost: 180, nameKey: "itemBackdropBigMan" },

  // 部屋の家具（複数設置可・sizeで一度に置ける数を制限）
  { key: "furniture_bed", category: "furniture", size: "large", cost: 0, origCost: 50, nameKey: "itemFurnitureBed" },
  { key: "furniture_shelf", category: "furniture", size: "small", cost: 0, origCost: 50, nameKey: "itemFurnitureShelf" },
  { key: "furniture_plant", category: "furniture", size: "small", cost: 0, origCost: 30, nameKey: "itemFurniturePlant" },
  { key: "furniture_rug", category: "furniture", size: "small", cost: 0, origCost: 30, nameKey: "itemFurnitureRug" },
  { key: "furniture_chair", category: "furniture", size: "small", cost: 0, origCost: 45, nameKey: "itemFurnitureChair" },
  { key: "furniture_piano", category: "furniture", size: "large", cost: 0, origCost: 120, nameKey: "itemFurniturePiano" },

  // 庭の置物（複数設置可・sizeで一度に置ける数を制限）
  { key: "garden_bench", category: "garden", size: "small", cost: 0, origCost: 40, nameKey: "itemGardenBench" },
  { key: "garden_fountain", category: "garden", size: "small", cost: 0, origCost: 60, nameKey: "itemGardenFountain" },
  { key: "garden_lantern", category: "garden", size: "small", cost: 0, origCost: 30, nameKey: "itemGardenLantern" },
  { key: "garden_flowerbed", category: "garden", size: "small", cost: 0, origCost: 40, nameKey: "itemGardenFlowerbed" },
  { key: "garden_field", category: "garden", size: "small", cost: 0, origCost: 90, nameKey: "itemGardenField" },
  { key: "garden_gazebo", category: "garden", size: "large", cost: 0, origCost: 100, nameKey: "itemGardenGazebo" },
  { key: "garden_pond", category: "garden", size: "large", cost: 0, origCost: 90, nameKey: "itemGardenPond" },
  { key: "garden_hay_bale", category: "garden", size: "small", cost: 0, origCost: 35, nameKey: "itemGardenHayBale" },

  // 壁掛けアイテム（複数設置可・床ではなく壁のエリアにのみ置ける）
  { key: "wallhang_painting", category: "wallhang", size: "small", cost: 0, origCost: 55, nameKey: "itemWallhangPainting" },
  { key: "wallhang_lamp", category: "wallhang", size: "small", cost: 0, origCost: 45, nameKey: "itemWallhangLamp" },
  { key: "wallhang_candle", category: "wallhang", size: "small", cost: 0, origCost: 25, nameKey: "itemWallhangCandle" },
  { key: "wallhang_hanger", category: "wallhang", size: "small", cost: 0, origCost: 30, nameKey: "itemWallhangHanger" },
  { key: "wallhang_clock", category: "wallhang", size: "small", cost: 0, origCost: 50, nameKey: "itemWallhangClock" }
];
