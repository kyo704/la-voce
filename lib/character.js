...
export const SHOP_ITEMS = [
  ...
  { key: "hat_western", category: "hat", cost: 60, nameKey: "itemHatWestern" },
  { key: "hat_crown_king", category: "hat", cost: 350, nameKey: "itemHatCrownKing" },
  { key: "hat_tiara_princess", category: "hat", cost: 350, nameKey: "itemHatTiaraPrincess" },
  ...
  { key: "outfit_western", category: "outfit", cost: 150, nameKey: "itemOutfitWestern" },

  // 持ち物（手に持つアクセサリー）
  { key: "accessory_staff", category: "accessory", cost: 200, nameKey: "itemAccessoryStaff" },
  { key: "accessory_sword", category: "accessory", cost: 220, nameKey: "itemAccessorySword" },
  ...
  { key: "floor_tatami", category: "floor", cost: 80, nameKey: "itemFloorTatami" },
  { key: "floor_terracotta", category: "floor", cost: 80, nameKey: "itemFloorTerracotta" },
  { key: "floor_indian", category: "floor", cost: 80, nameKey: "itemFloorIndian" },
  { key: "floor_american", category: "floor", cost: 80, nameKey: "itemFloorAmerican" },
  { key: "floor_chinese", category: "floor", cost: 80, nameKey: "itemFloorChinese" },

  // 壁（大物なので高め）
  { key: "wall_stripe", category: "wall", cost: 70, nameKey: "itemWallStripe" },
  { key: "wall_wood", category: "wall", cost: 70, nameKey: "itemWallWood" },
  { key: "wall_washi", category: "wall", cost: 80, nameKey: "itemWallWashi" },
  { key: "wall_mediterranean", category: "wall", cost: 80, nameKey: "itemWallMediterranean" },
  { key: "wall_indian", category: "wall", cost: 80, nameKey: "itemWallIndian" },
  { key: "wall_american", category: "wall", cost: 80, nameKey: "itemWallAmerican" },
  { key: "wall_chinese", category: "wall", cost: 80, nameKey: "itemWallChinese" },
  ...
  { key: "window_shoji", category: "window", cost: 50, nameKey: "itemWindowShoji" },
  { key: "window_mediterranean", category: "window", cost: 50, nameKey: "itemWindowMediterranean" },
  { key: "window_indian", category: "window", cost: 50, nameKey: "itemWindowIndian" },
  { key: "window_american", category: "window", cost: 50, nameKey: "itemWindowAmerican" },
  { key: "window_chinese", category: "window", cost: 50, nameKey: "itemWindowChinese" },
  ...
  { key: "garden_field", category: "garden", cost: 90, nameKey: "itemGardenField" }
];
