...
export const OUTBOUND_ROUTES = [
  ...
  },
  {
    ...
    note:
      ...
      "★しかも、画面に入口があります。私は最初『入口は無い』と書きましたが、" +
      "誤りでした（app/billing/page.js を開かずに推測しました）。" +
      "app/billing/page.js:138 が <CheckoutButton /> を描画し、" +
      "components/CheckoutButton.jsx:14 が /api/stripe/checkout を呼びます。" +
      "出る条件は「契約中でなく、iOSアプリでもない」だけで、" +
      "★REQUIRE_SUBSCRIPTION が無効な今は、契約中の人が居ません。" +
      "つまり★ウェブでログインした方が /billing を開くと、全員に出ます。" +
      "VocalTracker.jsx:11105 のナビにカードのアイコンもあります。",
    history: {
