...
export const AUTH_USER_REFERENCES = [
  ...
  { table: "assignments", column: "teacher_id", handledBy: "nulled", verified: true,
    note: "2026-09-02、NULLED_REFERENCES に登録。★行は残し、名前だけ外す"
        + "（lessons.teacher_id と同じ扱い。担当は生徒側の履歴でもあるため）。" }
];
