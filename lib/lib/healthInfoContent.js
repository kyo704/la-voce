...
export const HEALTH_INFO_CONTENT = {
  disclaimer: {
    ja: "ここに書かれている内容は一般的な情報提供を目的としたものであり、医学的な診断や治療の代わりになるものではありません。症状が続く場合や不安がある場合は、必ず耳鼻咽喉科（できれば音声を専門とする医師）にご相談ください。",
    en: "The information here is for general educational purposes only and is not a substitute for medical diagnosis or treatment. If symptoms persist or you feel concerned, please consult an ENT specialist (ideally one who specializes in voice care).",
    zh: "此处内容仅供一般信息参考，不能替代医学诊断或治疗。如症状持续或有任何担忧，请务必咨询耳鼻喉科医生（最好是专攻嗓音的医师）。",
    it: "Le informazioni qui riportate hanno solo scopo educativo generale e non sostituiscono una diagnosi o un trattamento medico. Se i sintomi persistono o hai dubbi, consulta uno specialista otorinolaringoiatra (idealmente specializzato in voce).",
    de: "Die hier bereitgestellten Informationen dienen nur allgemeinen Bildungszwecken und ersetzen keine medizinische Diagnose oder Behandlung. Bei anhaltenden Symptomen oder Bedenken wende dich bitte an einen HNO-Facharzt (idealerweise mit Spezialisierung auf Stimme).",
    fr: "Les informations présentées ici sont uniquement à titre informatif général et ne remplacent pas un diagnostic ou un traitement médical. Si les symptômes persistent ou vous inquiètent, consultez un ORL (idéalement spécialisé en voix).",
    es: "La información aquí presentada es solo con fines educativos generales y no sustituye un diagnóstico o tratamiento médico. Si los síntomas persisten o te preocupan, consulta a un otorrinolaringólogo (idealmente especializado en voz).",
    ko: "여기에 적힌 내용은 일반적인 정보 제공을 목적으로 하며, 의학적 진단이나 치료를 대신하지 않습니다. 증상이 지속되거나 불안하시면 반드시 이비인후과(가능하다면 음성을 전문으로 하는 의사)에 상담하세요."
  },
  ...
  s1Title: {
    ...
    ko: "역류성 식도염・인후두 역류질환(LPR)이 성악가에게 미치는 영향"
  },
  s1Para1: {
    ...
    ko: "역류성 식도염(위식도 역류질환, GERD)은 위산이 식도로 역류하여 염증을 일으키는 질환입니다. 위산이 식도를 넘어 후두・인두까지 도달하는 경우를 인후두 역류질환(LPR: Laryngopharyngeal Reflux)이라 부르며, 전형적인 속쓰림 없이 목에만 증상이 나타나는 경우가 많아 '침묵의 역류'라고도 불립니다."
  },
  s1Para2Intro: {
    ...
    ko: "성악가에게 특히 주의가 필요한 점은, LPR이 다음과 같은 형태로 발성에 직접 영향을 줄 수 있다는 것입니다."
  },
  s1List1: {
  ...
  s1Para3: {
    ...
    ko: "또한 만성적인 후두 염증이나 위화감은, 몸이 무의식적으로 목을 보호하려는 방어 반응(근긴장성 발성장애의 일종)을 일으킬 수 있으며, 이것이 **후두 거상**(후두가 원래보다 높은 위치로 올라가는 상태)으로 이어질 수 있다고 알려져 있습니다. 후두가 과도하게 올라간 상태에서는 성대의 자유로운 진동이 방해받아, 목소리의 신장감과 울림이 손상되기 쉬워집니다."
  },
  s1Para4Intro: {
    ja: "一般的に言われている対策です（診断や治療の代わりにはなりません）。",
    en: "Commonly suggested approaches (these are not a substitute for diagnosis or treatment).",
    zh: "以下是普遍建议的应对措施（不能替代诊断或治疗）。",
    it: "Approcci comunemente suggeriti (non sostituiscono una diagnosi o un trattamento).",
    de: "Häufig empfohlene Maßnahmen (kein Ersatz für Diagnose oder Behandlung).",
    fr: "Approches couramment suggérées (elles ne remplacent pas un diagnostic ou un traitement).",
    es: "Enfoques comúnmente sugeridos (no sustituyen un diagnóstico o tratamiento).",
    ko: "일반적으로 알려진 대책입니다(진단이나 치료를 대신하지 않습니다)."
  },
  s1List5: {
    ...
    ko: "취침 3시간 전까지 식사를 마친다. 특히 공연 전후의 식사 타이밍에 주의한다"
  },
  s1List6: {
    ja: "就寝時に上体をやや高くする",
  ...
  s1List7: {
    ...
    ko: "카페인・알코올・탄산음료・기름진 음식・초콜릿・감귤류 등 역류를 유발하기 쉽다고 알려진 음식을 파악해 둔다"
  },
  s1List8: {
  ...
  s1Note: {
    ...
    ko: "증상이 계속되는 경우 자가 판단으로 끝내지 말고, 이비인후과 진료를 받으시길 강력히 권장합니다."
  },
  ...
  s2Item1Desc: {
    ...
    ko: "목소리의 과사용이나 발성 방법에 의해 성대에 생기는 양성 병변. 목소리 쉼과 음역대 저하가 특징입니다."
  },
  s2Item2Term: {
    ja: "声帯出血",
  ...
  s2Item2Desc: {
    ...
    ko: "급격한 발성(과도한 고음이나 큰 소리) 후에 발생할 수 있는, 성대의 혈관이 파열되는 상태입니다. 즉각적인 발성 휴식이 필요합니다."
  },
  s2Item3Term: {
    ja: "筋緊張性発声障害",
  ...
  s2Item3Desc: {
    ...
    ko: "발성 시 목과 목 주변 근육이 과도하게 긴장하여 발생하는, 기질적 이상 없이 생기는 목소리 문제입니다."
  },
  s2Item4Term: {
    ja: "アレルギー性鼻炎・後鼻漏",
  ...
  s2Item4Desc: {
    ...
    ko: "콧물이 목으로 넘어가면서 위화감이나 헛기침의 원인이 되며, 발성에도 영향을 줄 수 있습니다."
  },
  s2Note: {
    ja: "これらはあくまで一般的な情報で、診断ではありません。声の不調が2週間以上続く場合は受診をおすすめします。",
    en: "This is general information only, not a diagnosis. If voice trouble persists for more than 2 weeks, we recommend seeing a doctor.",
    zh: "以上仅为一般信息，并非诊断。如声音不适持续2周以上，建议就医。",
    it: "Queste sono solo informazioni generali, non una diagnosi. Se il disturbo vocale persiste per più di 2 settimane, ti consigliamo di consultare un medico.",
    de: "Dies sind nur allgemeine Informationen, keine Diagnose. Wenn Stimmprobleme länger als 2 Wochen anhalten, empfehlen wir einen Arztbesuch.",
    fr: "Ceci est une information générale uniquement, pas un diagnostic. Si le trouble vocal persiste plus de 2 semaines, nous recommandons de consulter un médecin.",
    es: "Esto es solo información general, no un diagnóstico. Si el problema de voz persiste más de 2 semanas, recomendamos consultar a un médico.",
    ko: "이는 어디까지나 일반적인 정보이며 진단이 아닙니다. 목소리 불편이 2주 이상 지속되면 진료를 권장합니다."
  },
  ...
  s3List1: {
    ...
    ko: "수시로 수분을 보충한다(전신의 수분 상태가 성대의 촉촉함에도 영향을 준다고 알려져 있습니다)"
  },
  s3List2: {
    ja: "十分な睡眠",
  ...
  s3List4: {
    ...
    ko: "큰 소리로 대화하거나 과도하게 속삭이는 것을 피한다(속삭임도 성대에 부담을 준다고 알려져 있습니다)"
  },
  s3List5: {
    ja: "空気が乾燥した環境での加湿",
  ...
  s4Item1Desc: {
    ...
    ko: "안정된 숨의 흐름을 만드는 토대가 됩니다. 숨의 흐름이 안정될수록 음정의 안정과 프레이즈 지속이 쉬워진다고 알려져 있습니다."
  },
  s4Item2Term: {
    ja: "プランクなど体幹トレーニング",
  ...
  s4Item2Desc: {
    ...
    ko: "복횡근을 포함한 체간의 지지 근육을 단련함으로써, 날숨을 세밀하게 조절하기 쉬워집니다."
  },
  s4Item3Term: {
    ja: "ピラティス",
    en: "Pilates",
  ...
  s4Item3Desc: {
    ...
    ko: "체간의 의식적인 컨트롤과 호흡법을 결합하여 연습할 수 있어, 브레스 서포트의 감각을 기르는 데 적합합니다."
  },
  s4Sub2: {
    ja: "姿勢・喉頭の安定のために",
  ...
  s4Item4Desc: {
    ...
    ko: "새우등 등 자세가 흐트러지면 흉곽의 가동 범위가 좁아져 호흡이나 공명에 영향을 줄 수 있으므로, 평소에 풀어두는 것이 도움이 됩니다."
  },
  s4Item5Term: {
  ...
  s4Item5Desc: {
    ...
    ko: "목 주변의 과도한 긴장은 후두를 불필요하게 끌어올리는 원인 중 하나가 될 수 있다고 알려져 있습니다. 정기적으로 풀어주는 것이 중요합니다."
  },
  s4Item6Term: {
  ...
  s4Item6Desc: {
    ...
    ko: "후두가 자유롭게 움직일 수 있는 안정된 정렬(골격 배열)을 유지하는 데 도움이 됩니다."
  },
  s4Sub3: {
    ja: "全身持久力のために",
  ...
  s4Item7Desc: {
    ...
    ko: "심폐 기능 향상은 장시간의 공연이나 오케스트라와 함께하는 전곡 연주에서 체력을 유지하는 데 도움이 된다고 알려져 있습니다."
  },
  ...
  s5Item1Term: {
    ...
    ko: "초보자의 경우: 8~12회를 1세트, 2~3세트, 주 2~3회 정도"
  },
  s5Item1Desc: {
    ...
    ko: "일반적인 근력・근지구력 향상에 널리 사용되는 기준입니다. 올바른 자세를 익히기 쉽고, 부상 위험도 억제하기 쉬운 횟수 설정이라고 알려져 있습니다."
  },
  s5Item2Term: {
    ...
    ko: "익숙해지면 자세를 유지할 수 있는 범위 내에서 점차 부하나 횟수를 늘린다"
  },
  s5Item2Desc: {
    ...
    ko: "조금씩 부하를 높여감으로써 몸이 적응해 간다는 '점진적 과부하'의 개념에 기반합니다."
  },
  s5Note: {
    ...
    ko: "몸 상태가 걱정되거나 지병이 있는 경우, 시작하기 전에 의사와 상담하세요."
  },

  // ===== Section 6: Weight range =====
  s6Title: {
    ja: "身長からの参考体重レンジについて",
    en: "About the Reference Weight Range Based on Height",
    zh: "关于基于身高的参考体重范围",
    it: "Informazioni sull'intervallo di peso di riferimento basato sull'altezza",
    de: "Über den Referenzgewichtsbereich basierend auf der Körpergröße",
    fr: "À propos de la fourchette de poids de référence basée sur la taille",
    es: "Sobre el rango de peso de referencia basado en la altura",
    ko: "키를 기준으로 한 참고 체중 범위에 대하여"
  },
  s6Para1: {
    ja: "「今日の記録」の身体データ欄に表示される体重レンジは、一般的な健康指標であるBMI（体格指数）の標準範囲（18.5〜24.9）をもとに算出した、あくまで一般的な健康の目安です。声楽家に特化した専用の計算式ではありません。体重と歌唱能力の関係には個人差が大きく、筋肉量や体組成、そして発声技術の影響のほうがはるかに大きいとされています。この数値だけにとらわれず、体調管理の参考情報の一つとして捉えてください。",
    en: "The weight range shown in the Body Data section of \"Today's Record\" is calculated from the standard BMI (Body Mass Index) range (18.5–24.9), a general health indicator. It is not a formula specific to opera singers. The relationship between body weight and singing ability varies greatly by individual, and factors like muscle mass, body composition, and vocal technique are thought to matter far more. Please don't fixate on this number alone — treat it as just one piece of reference information for general health management.",
    zh: "「今日的记录」身体数据栏中显示的体重范围，是根据一般健康指标BMI（体格指数）的标准范围（18.5〜24.9）计算得出的，仅供一般健康参考。这并非专为声乐家设计的计算公式。体重与歌唱能力之间的关系因人而异，肌肉量、体成分以及发声技巧的影响被认为要大得多。请不要过分拘泥于这个数字，将其作为体调管理的参考信息之一即可。",
    it: "L'intervallo di peso mostrato nella sezione Dati corporei di \"Record di oggi\" è calcolato dall'intervallo standard dell'IMC (Indice di Massa Corporea, 18,5–24,9), un indicatore generale di salute. Non è una formula specifica per i cantanti lirici. La relazione tra peso corporeo e capacità canora varia molto da individuo a individuo, e fattori come massa muscolare, composizione corporea e tecnica vocale si ritiene contino molto di più. Non fissarti solo su questo numero: consideralo solo come un'informazione di riferimento tra tante per la gestione generale della salute.",
    de: "Der im Bereich Körperdaten von \"Heutiger Eintrag\" angezeigte Gewichtsbereich wird aus dem BMI-Standardbereich (Body-Mass-Index, 18,5–24,9) berechnet, einem allgemeinen Gesundheitsindikator. Es handelt sich nicht um eine speziell für Opernsänger entwickelte Formel. Der Zusammenhang zwischen Körpergewicht und Gesangsfähigkeit ist von Person zu Person sehr unterschiedlich, und Faktoren wie Muskelmasse, Körperzusammensetzung und Gesangstechnik gelten als weitaus bedeutsamer. Fixiere dich nicht nur auf diese Zahl — betrachte sie als eine von mehreren Referenzinformationen für die allgemeine Gesundheitspflege.",
    fr: "La fourchette de poids affichée dans la section Données corporelles de « Enregistrement du jour » est calculée à partir de la fourchette standard de l'IMC (Indice de Masse Corporelle, 18,5–24,9), un indicateur de santé général. Ce n'est pas une formule spécifique aux chanteurs lyriques. La relation entre le poids corporel et la capacité vocale varie beaucoup d'un individu à l'autre, et des facteurs comme la masse musculaire, la composition corporelle et la technique vocale seraient bien plus déterminants. Ne vous focalisez pas uniquement sur ce chiffre — considérez-le comme une simple information de référence parmi d'autres pour la gestion générale de la santé.",
    es: "El rango de peso mostrado en la sección Datos corporales de \"Registro de hoy\" se calcula a partir del rango estándar del IMC (Índice de Masa Corporal, 18,5–24,9), un indicador de salud general. No es una fórmula específica para cantantes de ópera. La relación entre el peso corporal y la capacidad de canto varía mucho según la persona, y se cree que factores como la masa muscular, la composición corporal y la técnica vocal importan mucho más. No te obsesiones solo con este número; considéralo como una pieza más de información de referencia para el manejo general de la salud.",
    ko: "'오늘의 기록'의 신체 데이터란에 표시되는 체중 범위는, 일반적인 건강 지표인 BMI(체격지수)의 표준 범위(18.5~24.9)를 바탕으로 산출한, 어디까지나 일반적인 건강 참고치입니다. 성악가에 특화된 전용 계산식이 아닙니다. 체중과 가창 능력의 관계에는 개인차가 크며, 근육량이나 체조성, 그리고 발성 기술의 영향이 훨씬 크다고 알려져 있습니다. 이 수치에만 얽매이지 말고, 컨디션 관리를 위한 참고 정보 중 하나로 받아들여 주세요."
  }
};
