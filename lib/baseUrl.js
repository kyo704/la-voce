...
export function getBaseUrl() {
  ...
  // ★プレビューでは、★ブランチのURLを先に使います（2026-09-04）。
  //   ★★VERCEL_URL は★配備ごとに変わるURLです（la-voce-gz3nns…）。
  //     ★そこへ戻されると、★別の生い立ちなので★cookie が付いてきません。
  //     ★★2026-09-04、決済のあとに★ログアウトした状態で戻されました。
  //   ★VERCEL_BRANCH_URL は、★ブランチごとの変わらないURLです
  //     （la-voce-git-stripe-test-…）。★試すときは、こちらに戻ります。
  //   ★無い環境もあるので、★無ければ VERCEL_URL に落とします。
