...
export const LEGS = Object.freeze({
  ...
  // ★★体は、★1ミリも動かしません（★2026-09-06・訂正）。
  //   ★★はじめ、★脚を見せるために体を36持ち上げました。
  //     ★これが誤りでした。★217点の服が、ぜんぶ上にずれ、
  //     ★着せた姿が変わってしまいました。
  //   ★★脚のために、★服の見た目を動かさないこと。
  //     ★脚は、★体の下の余白に収めます。
  lift:    0,

  // ★★下の4つは、★166点の版（v4）の仕様書の数字です。
  //   ★★新しい靴12点は、★この座標に合わせて描かれています。
  //     ★ここを勝手に変えると、★12点ぜんぶ描き直しになります。
  //     ★★まだ絵は使いませんが、★数字だけ先に合わせておきます。
  leftX:   421,   // ★足の中心x（左）
  rightX:  601,   // ★足の中心x（右）
  bottomY: 1002,  // ★足の下端。★靴の底が、ここに来ます
  footW:   114,   // ★足の幅
  groundY: 1006,  // ★接地線

  // ★★脚のつけ根（★2026-09-06、★900→780）。
  //   ★★軸を直したら、★振れが小さくなりすぎました。
  //     ★軸から足先までが短いと、★角度をつけても足は動きません。
  //   ★つけ根を上げると、★てこが長くなり、★同じ角度でよく動きます。
  //   ★★体は y=780 で x 294〜744 と広いので、★脚は隠れたままです。測りました。
  topY:    780,
  width:   54,    // ★脚の細いところ
  // ★★振れる角度（★2026-09-06、★16→14 に。★実機で「大きすぎる」）。
  //   ★★ただし、★大きく見えていた本当の原因は、★軸の誤りでした。
  //     ★軸を直したので、★見た目の振れは10分の1ほどになります。
  //     ★足りなければ、★ここを上げてください。★1か所です。
  swing:   14,
  sec:     0.62,  // ★いまの SVG の羊と同じ速さ
  hoofRy:  17,

  // ★★いまの靴8点は、★動かしません（shoeDy=0）。
  //   ★★底の高さが、★1点ずつ違います（954〜988）。測りました。
  //     ★下駄は台が高く、★わらじは平ら、★本番の靴はかかとがあります。
  //   ★★そろえて動かすと、★かえってずれます。
  //     ★描かれたままの場所で、★脚と一緒に振れます。
  shoeDy:  0
});
