...
//     ★★★2026-09-24、★裁定194 が 訂正されました ── 「★post か master」。
//       ★★はじめ「master だけ」と 書かれて いましたが、★誤り でした。
//       ★★★わけ（★裁定160 の 考え）── ★`post` は「役職を 変えられる 人」です。
//         ★★変えられる 人が、★変えた 記録を 見られないのは おかしい。
//         ★`master` だけに すると、★`post` の 人は「自分が 何を 変えたか」を
//           ★確かめられません。
...
export const NOTES = Object.freeze([
  ...
  // ★★2026-09-24 ── ★見本の 字に 合わせました。★鍵の 名（post・master）も 出します。
  //   ★★見る 方は 運営の 方 です。★鍵の 名が あった ほうが 確かめられます。
  "見られるのは、役職を 変えられる方（post）と 学校の 形を 直せる方（master）です。",
