...
/**
 * ★この方に 決める ── ★お尋ねの 1枚（★2026-09-21・坂本さんの お指図）。
 *
 *   ★★★押すと 戻せません。★だから 1度 お尋ねします。
 *     ★★`応募を 選ぶ` の「終わりにする」と 同じ 形 です。
 *     ★★裁定 その116 の 引き継ぎと 同じ 言い方に 揃えました ──
 *       ★★「押すと、その場で …… 取り消せません。」
 *   ★★★何が 起きるかを、★押す 前に 全部 書きます。
 *     ★★ほかの 方に「落ちました」とは 伝わりません。
 *     ★★それも 書きます。★気に なる ところ だから です。
 */
export const DECIDE = tx("この方に 決める");
export const DECIDE_ASK = tx("この方に 決めますか");
// ★★★`tx()` の 中で 字を つなぎません（★見張り `text-mark`）。
//   ★★つなぐと、★訳を 探す ときに 見つかりません。
//   ★★長く なっても 1つの 字の まま 置きます。
export const DECIDE_ASK_NOTE = tx("押すと、その場で 決まります。募集は 閉じます。取り消せません。ほかの 応募して くださった 方には、決まった わけを お伝えしません。");
export const DECIDE_OK = tx("決める");
export const DECIDE_CANCEL = tx("やめる");
