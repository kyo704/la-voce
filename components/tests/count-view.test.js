...
(async () => {
  ...
  console.log("\n=== ③ よそと くらべない ===");
  // ★★2026-09-14、★向きを 逆に しました。
  //
  //   ★★これまで「★実機では 但し書きを 出さない」と して いました。
  //   ★★ところが、★この 画面を 作った ときの 坂本さんの 覚え書きは
  //     ★こう 書いて います（★62afaa4）──
  //
  //       「まんなかの値です。くらべる先は、あなた自身です。よその目安は 出しません。」
  //       ★見本⑭の但し書きを、1文字も変えずに置いています。
  //       ★**この文がこの画面の芯です。**
  //
  //   ★★「出さない」に したのは、★そのあとの 別の 便（★ede0ae2）です。
  //     ★★お決めでは ありません。★見本にも、★作った ときの 覚え書きにも 反します。
  //   ★★だから「★出して いる こと」を 見る 形に 直しました。
    ...
    "★但し書きを 出して いる（★見本⑭の 芯）");
  {
    ...
    t(ui.includes(DISCLAIMER), "★但し書きは、★1文字も 変えずに 置いて いる");
  }
