...
if (habit) {
  ...
  assertTrue(habit.body.includes("throatCondition") && habit.body.includes("voiceQuality"),
    "喉と声の両方を見ている");
  // ★★2026-09-07、★効いた習慣ランキングのカードを外しました（8番・12番）。
  //   ★順位も、棒も、係数も出しません。★説明文も、一緒に消えました。
  //   ★★計算そのものは残ります。★関連の1文（habit.narrative）が使います。
  //     ★だから、★上の「喉と声の両方を見ている」は、そのまま見ます。
  assertTrue(!/効いた習慣ランキング<\/h3>/.test(vt),
    "★順位のカードが、戻ってきていない");
}
