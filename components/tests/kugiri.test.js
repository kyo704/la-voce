...
async function main() {
  ...
  // ★★★例外を 外しました（★2026-09-26）。
  //   ★★「4行目は 見本に ありません」と 書いて いました ── ★間違い でした。
  //     ★いまの 見本に 同じ 字が あります（★`<span class="usu">` の 中）。
  //   ★★★例外は 1つも 要りません。★4行 とも 見本から 数えます。
  約.forEach((l) => t(inMihon(l), `★見本に 同じ 字が ある …… 「${l.slice(0, 20)}…」`));
