...
(async () => {
  ...
  console.log("\n=== ⑦ 画面（★見本⑫の ○） ===");
  {
    ...
    // ★★★2026-09-21、★「判定」の 語を 外しました（★裁定157 T5）。
    //   ★★この 1文は、★いまの 見本に ありません（★探しました）。
    //     ★★だから「見本と 1文字も 違わない」とは 言えません。
    //   ★★見本が 同じ 考えに 使って いる 語に 揃えました ──
    //     ★★くらべる の「数えるときに 外します」と 同じ「数える」です。
    //   ★★★見本に この 1文が 戻ったら、★そちらの 字に 合わせて ください。
    t(/○は あとから書いた日です。目では見えますが、数えるときには 入れていません。/.test(raw),
      "★あとから書いた日の 凡例（★見本の「数える」に 揃えた）");
