 ...
 *     「日割りでのお返しはありません。★期間中は、いつでもご利用いただけます。」
 *     ★★2026-09-09 に、★言い方を そろえました。
 *       ★「返しません」の すぐ後ろに、★「使えます」を 対で 置きます。
 *   ★★書いたことと、実物を、そろえます。
 *
...
(async () => {
  ...
  // ★★2026-09-09、★言い方を そろえました（★坂本さんの お決め）。
  //   ★★「返しません」の すぐ後ろに、★「使えます」を 対で 置くこと。
  //     ★「更新日までは、そのままお使いいただけます」
  //     ★→「期間中は、いつでもご利用いただけます」
  //   ★★守りたいのは「★返さない、で 終わらせないこと」です。
  //     ★言い回しでは ありません。
  ok("★特商法に「期間中は、いつでも」と書いてある",
    /期間中は、いつでもご利用いただけます/.test(toku));
  // ★★対に なっていること。★片方だけに しないこと。
  ok("★★「返しません」と「使えます」が 対に なっている",
    /日割りでのお返しはありません。期間中は、いつでもご利用いただけます/.test(toku));
