...
// ★★★2026-09-23 ── ★止めて いる ことを **見える** ように しました。
//   ★★これまで、★止まって いる のに 0 で 終わって いました。
//     ★★だから 数えると 「緑」に 見えます。★1つも 確かめて いないのに、です。
//   ★★★`RESULT: PAUSED` と 書きます。★`tools/run_guards.py` が 別に 数えます。
//     ★緑とも 赤とも 数えません。★「止まって いる」と 出ます。
