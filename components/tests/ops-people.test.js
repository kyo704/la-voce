...
const 断り = "確かめ（ご自分で 選んだまま かどうか）は、まだ お作りして いません。";
...
t("★★「確かめ」の 列を 出して いない",
  !ui.slice(0, ui.indexOf(断り)).includes("確かめ"));
t("★★出して いない ことを、★黙って いない", ui.includes(断り));
t("★★出して いない ことを、★黙って いない",
  /確かめ（ご自分で 選んだまま かどうか）は、まだ お作りして いません/.test(ui));
