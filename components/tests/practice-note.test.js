...
(async () => {
  ...
  // ★★2026-09-24、★「ありません」を 足しました。
  //   ★★曲を 足す に 見本の 字を 入れました ── 「出来ばえ・点数の 欄は ありません。」
  //     ★★これも 打ち消し です。★入って いなかった だけ です。
  //   ★★ゆるめて いません ── ★打ち消しが 無ければ、★いまも 欄 と 見ます。
  const 打消 = /(出しません|出さない|ではありません|では ありません|ではない|しません|ありません)/;
  const 欄 = [];
