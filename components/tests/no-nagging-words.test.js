...
const MEASUREMENT_EXCEPTIONS = [
  ...
  // ★★2026-09-07・Opus が確定した言い方。★日本語は1文字も変えられません。
  //   ★★ここの「まだ」は、★開発者が「自分がまだ確かめていない」と言っています。
  //     ★利用者を急かしていません。★上の「私（開発者）の作り忘れです」と同じ形です。
  //   ★★外すと、★「当たります」と言い切ったことになります。
  //     ★確かめていないことを、★確かめたように見せてはいけません。
  { text: "当たるかどうかは、まだ確かめていません",
    why: "開発者が、自分がまだ確かめていないと言う言葉。★外すと「当たる」と断定したことになる" }
];
...
console.log("\n=== 直した3つが、戻っていない ===");
{
  ...
  // ★★2026-09-07、★快適帯を外したので、★この言い換えの置き場も無くなりました。
  //   ★「まだ結論を出していません」が戻っていないことは、★上の行が見ています。
}
