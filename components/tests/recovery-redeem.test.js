...
//   ★確かめは、このあとの番号でします。
//
// ★★2026-09-05 夜、★私はいちど true に変えました。★間違いでした。
//   ★「確かめていないアドレスには番号が送られないはずだ」と推論しました。
//   ★実機では、★false のまま、★届いて、★通りました。
//   ★★動いている形を、★確かめずに変えないこと。
ok("★email_confirm: false にしている（★実機で通った形）",
  /email_confirm: false/.test(r));
...
// ★★動いている形を、確かめずに変えない ── その戒めが、コードに残っていること。
ok("★推論で変えた経緯が、コードに残っている",
  /動いている形を、★確かめずに変えないこと/.test(
    readRaw("app", "api", "recovery", "redeem", "route.js")));
