...
function RoomScene({ equipped, owned, onTogglePlacement, onUpdatePosition, wardrobeOn = false, say = null, t, cameraOn = false, fullBleed = false }) {
  ...
  // ★★2026-09-10、★ここを 見本 A07 の 寸法に しました。★戻しました。
  //   ★★坂本さんの お決め ──「★ひつじの 画面の 羊が 3倍の 大きさに
  //     ★なってしまっています。★これは 誤りです。★元の 大きさに 戻してください」
  //   ★★見本 A07 は たしかに 羊 230px（★列 330px の 70％）と 書いています。
  //     ★A01（きょう）の 186px より 大きい 数です。★見本の 取りちがえでは
  //     ★★ありませんでした。★私の 単位の 取りちがえでした ──
  //       ★列の 幅（330）では なく、★枠の 高さ（452）に 掛けていました。
  //       ★★331px に なりました。★見本の 230px より さらに 大きい 数です。
  //   ★★そして、★A07 の 絵は「★羊を ながめる」1枚です。
  //     ★アプリの 部屋は、★羊が 歩き、★家具が 置いてあります。
  //     ★70％の 羊は、★歩く 場所を 残しません。
  //   ★→ ★元の 幅 26％に 戻します。★門の 中も 外も 同じです。
  ...
  const cam = cameraOf({
    ...
    // ★★2026-09-13、★はじめ WALL_BAND[0]（＝5）を 渡しました。
    //   ★★窓は 入りましたが、★**羊が 下で 切れました**。
    //   ★★算 ── 1.6倍で 見える 範囲は 100÷1.6 ＝ **62.5％**。
    //     ★窓の 上端 13％ 〜 羊の 足もと 約80％ ＝ **67％** 要ります。
