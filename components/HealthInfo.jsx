  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="歌手に役立つ運動 — 目的別に整理" icon={Dumbbell}>
        <Note>
          正直にお伝えすると、「声種によって必要な筋力トレーニングが異なる」という科学的な裏付けは見当たりませんでした。
          声種（ソプラノ、メゾソプラノ、テノールなど）は主に声帯の長さや厚みといった解剖学的特性による分類であり、
          体力トレーニングの必要性を直接左右するものではないとされています。そのため声種別ではなく、
          歌手にとって特に意味のある「目的別」に整理しています。
        </Note>
        <div>
          <p className="font-medium mt-2">呼吸支持（ブレスサポート）のために</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>横隔膜呼吸（腹式呼吸）の練習</li>
            <li>プランクなど体幹を使うトレーニング</li>
            <li>ピラティス</li>
          </ul>
        </div>
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>背中・肩甲骨まわりのストレッチ</li>
            <li>首・肩のストレッチ、緊張のリリース</li>
            <li>姿勢を意識したエクササイズ（壁を使った姿勢チェックなど）</li>
          </ul>
        </div>
        <div>
          <p className="font-medium mt-2">全身持久力のために</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>ウォーキングや軽いジョギングなどの有酸素運動（公演中の体力維持に役立つとされています）</li>
          </ul>
        </div>
      </Section>
      ...
      <Section title="筋トレ回数の一般的な目安" icon={Dumbbell}>
        <p>
          体重・身長・声種から専用の回数を割り出す、といった方法は科学的根拠のあるものではないため、
          このアプリでは行っていません。代わりに、健康な成人向けの一般的なトレーニング目安をご紹介します。
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>初心者の場合：8〜12回を1セットとして、2〜3セット、週2〜3回程度</li>
          <li>慣れてきたら、正しいフォームを保てる範囲で徐々に負荷や回数を増やす</li>
        </ul>
