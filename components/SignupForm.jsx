...
const ST = {
  nativeTitle: { ja: "ご登録について", en: "About Signing Up", zh: "关于注册", it: "Informazioni sulla registrazione", de: "Zur Registrierung", fr: "À propos de l'inscription", es: "Sobre el registro", ko: "가입 안내" },
  ...
  doneTitle: { ja: "確認メールを送信しました", en: "Confirmation Email Sent", zh: "确认邮件已发送", it: "E-mail di conferma inviata", de: "Bestätigungs-E-Mail gesendet", fr: "E-mail de confirmation envoyé", es: "Correo de confirmación enviado", ko: "확인 이메일을 보냈습니다" },
  doneBody: { ja: "{email} 宛にメールを送信しました。メール内のリンクをクリックして登録を完了してください。", en: "We've sent an email to {email}. Please click the link in the email to complete your registration.", zh: "已向 {email} 发送邮件。请点击邮件中的链接以完成注册。", it: "Abbiamo inviato un'e-mail a {email}. Clicca sul link nell'e-mail per completare la registrazione.", de: "Wir haben eine E-Mail an {email} gesendet. Bitte klicke auf den Link in der E-Mail, um die Registrierung abzuschließen.", fr: "Nous avons envoyé un e-mail à {email}. Veuillez cliquer sur le lien dans l'e-mail pour terminer votre inscription.", es: "Hemos enviado un correo a {email}. Haz clic en el enlace del correo para completar tu registro.", ko: "{email} 주소로 메일을 보냈습니다. 메일 안의 링크를 클릭하여 가입을 완료해 주세요." },
  title: { ja: "La Voce に登録", en: "Sign Up for La Voce", zh: "注册 La Voce", it: "Registrati su La Voce", de: "Bei La Voce registrieren", fr: "S'inscrire à La Voce", es: "Regístrate en La Voce", ko: "La Voce 가입" },
  ...
  privacyLink: { ja: "プライバシーポリシー", en: "Privacy Policy", zh: "隐私政策", it: "Informativa sulla privacy", de: "Datenschutzerklärung", fr: "politique de confidentialité", es: "política de privacidad", ko: "개인정보처리방침" },
  placeholderName: { ja: "お名前", en: "Your name", zh: "姓名", it: "Nome", de: "Name", fr: "Nom", es: "Nombre", ko: "이름" },
  ...
  labelIsStudent: { ja: "学生です", en: "I'm a student", zh: "我是学生", it: "Sono uno studente/una studentessa", de: "Ich bin Student/in", fr: "Je suis étudiant(e)", es: "Soy estudiante", ko: "학생입니다" },
  labelSchool: { ja: "学校名", en: "School name", zh: "学校名称", it: "Nome della scuola", de: "Name der Schule", fr: "Nom de l'établissement", es: "Nombre de la escuela", ko: "학교명" },
  placeholderSchoolExample: { ja: "例：〇〇音楽大学", en: "e.g. Ondo College of Music", zh: "例：〇〇音乐大学", it: "Es.: Conservatorio 〇〇", de: "Z. B.: Musikhochschule 〇〇", fr: "Ex. : Conservatoire 〇〇", es: "Ej.: Conservatorio 〇〇", ko: "예: 〇〇음악대학" },
  labelOccupation: { ja: "職業", en: "Occupation", zh: "职业", it: "Professione", de: "Beruf", fr: "Profession", es: "Ocupación", ko: "직업" },
  placeholderOccupationExample: { ja: "例：声楽家、会社員 など", en: "e.g. singer, office worker", zh: "例：声乐家、公司职员等", it: "Es.: cantante, impiegato/a", de: "Z. B.: Sänger/in, Angestellte/r", fr: "Ex. : chanteur/euse, employé(e)", es: "Ej.: cantante, empleado/a", ko: "예: 성악가, 회사원 등" },
  placeholderPassword: { ja: "パスワード（8文字以上）", en: "Password (8+ characters)", zh: "密码（8位以上）", it: "Password (min. 8 caratteri)", de: "Passwort (mind. 8 Zeichen)", fr: "Mot de passe (8 caractères min.)", es: "Contraseña (8 caracteres o más)", ko: "비밀번호(8자 이상)" },
  btnLoading: { ja: "処理中…", en: "Processing…", zh: "处理中…", it: "Elaborazione in corso…", de: "Wird verarbeitet…", fr: "Traitement en cours…", es: "Procesando…", ko: "처리 중…" },
  btnSubmit: { ja: "登録する", en: "Sign up", zh: "注册", it: "Registrati", de: "Registrieren", fr: "S'inscrire", es: "Registrarse", ko: "가입하기" },
  haveAccountText: { ja: "すでにアカウントをお持ちの方は", en: "Already have an account?", zh: "已有账户？", it: "Hai già un account?", de: "Schon ein Konto?", fr: "Vous avez déjà un compte ?", es: "¿Ya tienes una cuenta?", ko: "이미 계정이 있으신가요?" },
  linkLogin: { ja: "ログイン", en: "Log in", zh: "登录", it: "Accedi", de: "Anmelden", fr: "Se connecter", es: "Iniciar sesión", ko: "로그인" },
  agreementText: { ja: "登録すると{terms}と{privacy}に同意したものとみなされます。", en: "By signing up, you agree to our {terms} and {privacy}.", zh: "注册即表示您同意我们的{terms}与{privacy}。", it: "Registrandoti, accetti i nostri {terms} e la nostra {privacy}.", de: "Mit der Registrierung stimmst du unseren {terms} und unserer {privacy} zu.", fr: "En vous inscrivant, vous acceptez nos {terms} et notre {privacy}.", es: "Al registrarte, aceptas nuestros {terms} y nuestra {privacy}.", ko: "가입하면 {terms} 및 {privacy}에 동의하는 것으로 간주됩니다." },
  termsLink: { ja: "利用規約", en: "Terms of Service", zh: "使用条款", it: "Termini di servizio", de: "Nutzungsbedingungen", fr: "conditions d'utilisation", es: "términos de servicio", ko: "이용약관" },
};
