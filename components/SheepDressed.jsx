      ...
      {layers.map((l, i) => (
        ...
        <ClothImage
          ...
          style={{
            ...
            //   ★★上ぞろえ（inset:0）で 重ねると、★中身が 256px 下に ずれます。
            //     ★★これが「兜が おかしい」の 正体でした。
            //     ★私は 1024×1024 の 古い版（★上が切れたもの）を 測って、
            //     ★★「絵は そろっている」と 2度 申しました。★誤りでした。
            //
            //   ★★下のはしを そろえれば、★高い絵は 上へ 伸びます。
            //     ★1024×1024 の品は、★これまでと 1画素も 変わりません。
            //     ★height:auto なので、★絵の たての比が そのまま 出ます。
            //   ★★objectFit:contain を 使わないこと。
            //     ★あれは「枠に 収める」ので、★はみ出させたい ここでは 逆です。
            //
            //   ★見本と 1画素も 違わないことを、★重ねて 確かめました
            //     （★worn/*.png との ちがい 平均 0.00）。
