...
export default function HomeDrawer({
  ...
  colorBand = null,
  // ★★色の帯の 2段目（★柄もの ＋ ¥1,280 のときだけ・2026-09-08 夜）。
  //   ★★渡されなければ、★1段ぶんの場所も 空けません。
  //   ★★既定は 全員 同じです。★これは その上に 重ねるだけです。
  colorBand2 = null,
  children
}) {
  ...
  return (
    <div
      ...
      {/* ★★色の帯の 2段目（★2026-09-08 夜）。★1段目の すぐ下です。
          ★★柄もの ＋ ¥1,280 の方のときだけ 出ます。
            ★出ないときは、★場所も 空けません（★1段目とは ちがう扱いです）。
            ★1段目は「色を変えられる」という説明を 兼ねているので 出したままですが、
            ★★2段目は、★出せない方に 場所だけ見せても 意味が ありません。 */}
      {colorBand2}
