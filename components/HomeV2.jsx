...
export default function HomeV2({
  ...
  return (
    ...
    <div style={{ fontFamily: FONT_STACK }}>
      ...
      {/* ★★★渡された 子を、★ここで 出します（★2026-09-15）。
          ★★★`children` は、★受け取って いるのに **出して いません** でした。
            ★★44行目で `children` と 書いて あるのに、
              ★どこにも `{children}` が ありません でした。
            ★★だから、★渡した ものは 黙って 捨てられて いました。
            ★★エラーに なりません。★誰も 気づきません。
          ★★これで 2度目 です ── ★「名前は ある。★もの が ない」。
            ★`research.anonymized` も 同じ 形 でした（★定義は ある。★読む人が いない）。
            ★★**受け取って いる ことは、★出して いる ことでは ありません。**
          ★★ここに 置く わけ（★第3版 §6-2 の 図）──
            ```
            きょう
              ├ 今日の記録            ← いまある（★上の 帯）
              ├ ★次のレッスン
              ...
              └ ★近い行事
            ```
            ★「きょうの よてい」の あと、★いちばん 下です。
          ★★見張り `classroom-shell.test.js` が、★出して いることを 見ます。 */}
      {children}
